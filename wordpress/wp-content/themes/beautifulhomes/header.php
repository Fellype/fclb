            ...
            <?php else:?>
                <div id="logo" class="logo_text navbar-header">
                    <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<?php echo wpml_t(THEME_NAME, 'Logo Text',stripslashes(wt_get_option('general','plain_logo'))); ?>
					</a>
...
<?php } else {
	if(!is_front_page()) { ?>
    	...
    	<div class="container">
            ...
            <?php else:?>
                <div id="logo" class="logo_text navbar-header">
                    <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_attr( wt_get_option('general','plain_logo')); ?></a>
                <?php if(wt_get_option('general','display_site_desc')){
                        $site_desc = get_bloginfo( 'description' );
                        if(!empty($site_desc)):?>
                        <div id="siteDescription"><?php bloginfo( 'description' ); ?></div>
