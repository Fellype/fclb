...
if(!function_exists('wt_googlefonts_getfonts')){
	function wt_googlefonts_getfonts(){
		return array(
			...
			"Oldenburg"=>"Oldenburg",
			"Open%20Sans:400,300italic,800italic,800,700italic,700,600italic,600,400italic,300"=>"Open Sans (all weights)",
...
$wt_options = array(
	array(
		...
		"default" => '',
		"options" => array(
			"font_size" => esc_html__('Font Size','wt_admin'),
			"google_fonts" => esc_html__('Google Fonts','wt_admin'),
			"font_face" => esc_html__('Font Face','wt_admin'),
		),
		"type" => "wt_navigation",
	),
	...
	array(
		...
		array(
			"name" => esc_html__("Font General",'wt_admin'),
			"type" => "wt_open"
		),
		array(
			"name" => esc_html__("Font Family",'wt_admin'),
			"desc" => 'Choose the font-family you want to use on your site.',
			"id" => "font_family",
			"default" => '"Open Sans", Helvetica, Arial, sans-serif;',
			"options" => array(
				'"Open Sans", Helvetica, Arial, sans-serif;' => '"Open Sans", Helvetica, Arial, sans-serif;',
		...
		array(
			"name" => esc_html__("Page Text Size",'wt_admin'),
			"id" => "content_page",
			"min" => "1",
			"max" => "60",
			"step" => "0.5",
		...
		array(
			"name" => esc_html__("Font Size",'wt_admin'),
			"type" => "wt_open"
		),
		array(
			"name" => esc_html__("Logo Text Size",'wt_admin'),
			"id" => "logo_size",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => esc_html__("Logo Description Size",'wt_admin'),
			"id" => "logo_size_desc",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => esc_html__("Top Level Menu Text Size",'wt_admin'),
			"id" => "menu_top",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => esc_html__("Sub Level Menu Text Size",'wt_admin'),
			"id" => "menu_sub",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => sprintf(esc_html__("%s Size",'wt_admin'),'H1'),
			"id" => "content_h1",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => sprintf(esc_html__("%s Size",'wt_admin'),'H2'),
			"id" => "content_h2",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" =>  sprintf(esc_html__("%s Size",'wt_admin'),'H3'),
			"id" => "content_h3",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" =>  sprintf(esc_html__("%s Size",'wt_admin'),'H4'),
			"id" => "content_h4",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" =>  sprintf(esc_html__("%s Size",'wt_admin'),'H5'),
			"id" => "content_h5",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" =>  sprintf(esc_html__("%s Size",'wt_admin'),'H6'),
			"id" => "content_h6",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => esc_html__("Sidebar Widget Title",'wt_admin'),
		...
		/*array(
			"name" => esc_html__("Intro Header Title Size",'wt_admin'),
		...
		array(
			"name" => esc_html__("Intro Header Text Size",'wt_admin'),
			"id" => "description_text",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => esc_html__("Footer Text",'wt_admin'),
			"id" => "footer_text",
			"min" => "1",
			"max" => "60",
			"step" => "0.5",
		...
		array(
			"name" => esc_html__("Footer Widget Title",'wt_admin'),
			"id" => "footer_title",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => esc_html__("Copyright Text Size",'wt_admin'),
			"id" => "copyright",
			"min" => "1",
			"max" => "60",
			"step" => "0.5",
		...
		/*array(
			"name" => esc_html__("Footer Menu Text Size",'wt_admin'),
			"id" => "footer_menu",
			"min" => "1",
			"max" => "60",
			"step" => "1",
		...
		array(
			"name" => esc_html__("Footer Bottom Menu Text Size",'wt_admin'),
	...
	array(
		...
		array(
			"name" => esc_html__("Google Fonts",'wt_admin'),
			"type" => "wt_open"
		),
			array(
				"name" => esc_html__("Enable Google Fonts",'wt_admin'),
			...
			array(
				"name" => esc_html__("Google Fonts",'wt_admin'),
				"desc" => esc_html__('Go to') . ' <a href="http://www.google.com/webfonts" target="_blank">' . esc_html__('Google webfonts library') . '</a>' . esc_html__(' to see google fonts samples. In order to select a font you should click on it.','wt_admin'),
				"id" => "used_googlefonts",
				"default" => array('Open%20Sans:400,300italic,800italic,800,700italic,700,600italic,600,400italic,300','Oswald:400,300,700'),
				"prompt" => esc_html__("Choose google font...","wt_admin"),
				"chosen" => "true",
				"type" => "wt_multiselect",
				"options"=> wt_googlefonts_getfonts(),
			),
			array(
				"name" => esc_html__("Google Fonts Custom CSS",'wt_admin'),
				"desc" => esc_html__('Sample: ') . '<br><code>' . esc_html__('h1,h2,h3,h4,h5 { font-family: Droid Sans; }') . '</code><br><br>' . esc_html__(' You should use this option if there are more google fonts selected.','wt_admin'),
				"id" => "gfonts_code",
				"default" => '
...
',
	...
	array(
		...
		array(
			"name" => esc_html__("@font-face General",'wt_admin'),
			"type" => "wt_open"
		),
			array(
				"name" => esc_html__("Enable @font-face",'wt_admin'),
				"id" => "enable_fontface",
				"default" => false,
				"type" => "wt_toggle"
			),
			array(
				"name" => esc_html__("@font-face Custom CSS",'wt_admin'),
				"desc" => esc_html__('Sample: ') . '<br><code>' . esc_html__('h1,h2,h3,h4,h5 { font-family:CuprumFFURegular; }') . '</code>',esc_html__('wt_admin'),
				"id" => "fontface_code",
				"default" => "",
				"rows" => '8',
				"type" => "wt_textarea"
		...
		array(
			"name" => sprintf(esc_html__('Fonts located in "%s"','wt_admin'),'<code>'.str_replace( WP_CONTENT_DIR, '', THEME_FONTFACE_DIR ).'</code>'),
			"type" => "wt_open"
		),
			array(
				"id" => "fonts",
