...
$wt_options = array(
	...
	array(
		...
		array(
			...
			"id" => "logo",
			"default" =>  "http://whoathemes.com/files/pics/logos/xlander.png",
			"type" => "wt_upload",
			"crop" => "false"
		),
		array(
		...
		*/		
		...
		array(
			...
			"desc" => esc_html__("W-P-L-O-C-K-E-R-.-C-O-M - This option enables a scroll to top button at the right bottom corner of site pages.",'wt_admin'),
			"id" => "scroll_to_top",
			"default" => false,
			"type" => "wt_toggle"
		),
	...
	array(
		...
		array(
			...
			array(	
				...
				"id" => "favicon",
				"default" => 'http://whoathemes.com/files/pics/favicons/xlander/favicon.ico',
				"type" => "wt_upload",
				"crop" => "false"
			),			
			array(	
				...
				"id" => "favicon_57",
				"default" => 'http://whoathemes.com/files/pics/favicons/xlander/favicon_57.png',
				"type" => "wt_upload",
				"crop" => "false"
			),		
			array(	
				...
				"id" => "favicon_72",
				"default" => 'http://whoathemes.com/files/pics/favicons/xlander/favicon_72.png',
				"type" => "wt_upload",
				"crop" => "false"
			),		
			array(	
				...
				"id" => "favicon_114",
				"default" => 'http://whoathemes.com/files/pics/favicons/xlander/favicon_114.png',
				"type" => "wt_upload",
				"crop" => "false"
			),	
			array(	
				...
				"id" => "favicon_144",
				"default" => 'http://whoathemes.com/files/pics/favicons/xlander/favicon_144.png',
				"type" => "wt_upload",
				"crop" => "false"
			),
		array(
	...
	array(
		...
		array(
			...
			array(
				...
				"desc" => esc_html__("THEME SHARED ON WPLOCKER.COM - Paste your <a href='http://www.google.com/analytics/' target='_blank'>analytics code</a> here and it will be applied to each page.",'wt_admin'),
				"id" => "analytics",
				"default" => "",
				"elastic" => "true",
				"type" => "wt_textarea"
