...
function wt_enqueue_scripts() {
	...
	wp_register_script( 'jquery-YTPlayer', THEME_JS .'/vendor/jquery.mb.YTPlayer.js', array('jquery'), null, true);
...
function wt_enqueue_styles(){
	...
	wp_register_style('YTPlayer', THEME_CSS.'/YTPlayer.css', array('theme-style'), null, 'all');
