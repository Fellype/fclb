...
class Wt_Widget_Recent_Portfolio_Posts extends WP_Widget {
	...
	function Wt_Widget_Recent_Portfolio_Posts() {
		$widget_ops = array('classname' => 'widget_recent_portfolio_posts', 'description' => esc_html__( "The most recent portfolio posts", 'wt_admin') );
		$this->WP_Widget('recent_portfolio_posts', THEME_SLUG.' - '.esc_html__('Recent Portfolio Posts', 'wt_admin'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Recent Portfolio Posts', 'wt_front') : $instance['title'], $instance, $this->id_base);
