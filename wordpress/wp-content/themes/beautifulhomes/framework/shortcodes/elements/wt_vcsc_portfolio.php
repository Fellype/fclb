...
if (function_exists('wpb_map')) {
	...
	wpb_map( array(
		'name' => esc_html__('WT Portfolio', 'wt_vcsc'),
		'base' => 'wt_portfolio',
		'icon' => 'wt_vc_ico_portfolio',
		'class' => 'wt_vc_sc_portfolio',
		'category' => esc_html__('by WhoaThemes', 'wt_vcsc'),
		'description' => esc_html__('Recent portfolio posts', 'wt_vcsc'),
		'params' => array(
			array(
				'type'			=> 'dropdown',
				'class'			=> '',
				...
				'std'	        => '4',
				'description'	=> esc_html__( 'How many columns? Only \'1, 2, 3, 4, 6\' are accepted.', 'wt_vcsc' ),
			),
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Portfolio Grid Spaces', 'wt_vcsc'),
				'param_name'    => 'grid_spaces',
				'value' => array( 
					__('No', 'wt_vcsc')    => 'false',
					__('Yes', 'wt_vcsc')   => 'true',
				),
				'description'   => esc_html__('If selected, portfolio articles will have spaces around.', 'wt_vcsc')
			),
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Portfolio Overlay Title / Excerpt', 'wt_vcsc'),
				'param_name'    => 'overlay_desc',
				'value' => array( 
					__('Yes', 'wt_vcsc')   => 'true',
					__('No', 'wt_vcsc')    => 'false',
				),
				'description'   => esc_html__('If selected, title and portfolio excerpt will overlay the featured image on hover.', 'wt_vcsc')
			),
			array(
				'type'          => 'textfield',
				'heading'       => esc_html__('Max (posts number)', 'wt_vcsc'),
				'param_name'    => 'max',
				'value'         => '-1',
			...
			array(
				...
				'description'   => esc_html__('Display pagination.', 'wt_vcsc')
			),		
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Pagination alignment', 'wt_vcsc'),
				...
				'description'   => esc_html__('Aligns pagination links to left / center / right.', 'wt_vcsc')
			),
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Sortable', 'wt_vcsc'),
				'param_name'    => 'sortable',
				'value' => array( 
					__('No', 'wt_vcsc')    => 'false',
					__('Yes', 'wt_vcsc')   => 'true',
				),
				'description'   => esc_html__('Display sortable portfolio. Posts will be sorted and grouped by category. This will disable "Pagination" above option.', 'wt_vcsc')
			),
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Carousel', 'wt_vcsc'),
				'param_name'    => 'carousel',
				'value'         => array( 
					__('No', 'wt_vcsc')    => 'false',
					__('Yes', 'wt_vcsc')   => 'true',
				),
				'description'   => esc_html__('Display portfolio posts with carousel. This will disable "Pagination & Sortable" above options.', 'wt_vcsc')
			),
			array(
				'type'               => 'textfield',
				'heading'            => esc_html__('Carousel Autoscrolling', 'wt_vcsc'),
				...
				'description'   => esc_html__('Enables autoscrolling and define the time interval (in miliseconds - Ex: 3000, 4000, 5000 etc) between transitions.', 'wt_vcsc')
			),
			array(
				'type'               => 'dropdown',
				'heading'            => esc_html__('Carousel Navigation', 'wt_vcsc'),
				...
				'description'   => esc_html__('Enables carousel navigation ( prev / next buttons ).', 'wt_vcsc')
			),
			array(
				'type'          => 'dropdown',
			...
			array(
				'type'               => 'dropdown',
				'heading'            => esc_html__('Title linkable', 'wt_vcsc'),
				...
				'description'   => esc_html__('Link on title?', 'wt_vcsc')
			),
			array(
				'type'          => 'dropdown',
			...
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Category', 'wt_vcsc'),
				'param_name'    => 'category',
				'value' => array( 
					__('Yes', 'wt_vcsc')   => 'true',
					__('No', 'wt_vcsc')    => 'false',
				...
				'std'           => 'false',
				'description'   => esc_html__('Display portfolio post category.', 'wt_vcsc')
			),	
			array(
				'type'			=> 'dropdown',
				'class'			=> '',
			...
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Group', 'wt_vcsc'),
				'param_name'    => 'group',
				'value' => array( 
					__('Yes', 'wt_vcsc')   => 'true',
					__('No', 'wt_vcsc')    => 'false',
				),
				'description'   => esc_html__('Portfolio item tuhmbnails (featured images) will be grouped in the lightbox.', 'wt_vcsc')
			),			
			array(
				'type'          => 'wt_multidropdown',
				'heading'       => esc_html__('Display specific portfolio items (optional)', 'wt_vcsc'),
				'param_name'    => 'ids',
				'value'         => '',
				'target'        => 'wt_portfolio',
				'description'   => esc_html__('Display only specific / selected portfolio items.', 'wt_vcsc') .'<b>' . esc_html__('Hold the \'Ctrl\' or \'Shift\' keys while clicking to select multiple items', 'wt_vcsc').'</b>.'
			),
			array(
				'type'          => 'wt_multidropdown',
				...
				'description'   => esc_html__('Display portfolio items from selected categories.', 'wt_vcsc') .'<b>' . esc_html__('Hold the \'Ctrl\' or \'Shift\' keys while clicking to select multiple items', 'wt_vcsc').'</b>.'
			),	
			array(
				'type'          => 'wt_multidropdown',
				'heading'       => esc_html__('Exclude selected categories (optional)', 'wt_vcsc'),
				'param_name'    => 'cat__not',
				'value'         => '',
				'target'        => 'wt_portfolio_category',
				'description'   => esc_html__('Display portfolio items and exclude selected categories.', 'wt_vcsc') .'<b>' . esc_html__('Hold the \'Ctrl\' or \'Shift\' keys while clicking to select multiple items', 'wt_vcsc').'</b>.'
			),		
			array(
				'type'			=> 'dropdown',
				'class'			=> '',
