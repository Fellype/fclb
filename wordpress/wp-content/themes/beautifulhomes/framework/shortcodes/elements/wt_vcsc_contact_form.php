...
class WPBakeryShortCode_WT_contact_form extends WPBakeryShortCode {
	...
	protected function content($atts, $content = null) {
		...
		if ( in_array('message', $fields) ) {
			...
			$output .= '<textarea id="contact_content_'.$id.'" name="contact_content_'.$id.'" class="text_area" placeholder="'.$placeholder.$req.'"'.$req_attr.' tabindex="9"></textarea>';
			$output .= '</div>';
			$output .= '</div>';
		}
		
		$output .= '<div class="col-lg-12 col-md-12 col-sm-12 text-center">';
	...
	wpb_map( array(
		...
		'params'        => array(
			...
			array(
				...
				'value'         => esc_html__('Submit', 'wt_vcsc'),
