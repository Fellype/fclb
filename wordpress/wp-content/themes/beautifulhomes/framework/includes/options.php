...
class wt_options {
	...
	function wt_reset($get_options) {
		...
		echo "<p class=\"reset\"><input type=\"submit\" name=\"reset_options\" class=\"button button-secondary button-large autowidth\" value=\"Reset\" onclick=\"return confirm( 'Are you sure you want to reset? All the above settings will be reset to defauls! W.P.L.O.C.K.E.R...C.O.M";
		echo '\n';
