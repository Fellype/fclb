    ...
    if ( ! class_exists( 'Redux_Framework_sample_config' ) ) {
        ...
        class Redux_Framework_sample_config {
            ...
            public function setSections() {
                ...
                $this->sections[] = array(
                    'title'  => __( 'Home Settings', 'firstone_domain' ),
                    'desc'   => sprintf( __( 'Redux Framework was created with the developer in mind. It allows for any theme developer to have an advanced theme panel with most of the features a developer would need. For more information check out the Github repo at: %d', 'firstone_domain' ), '<a href="' . 'https://' . 'github.com/ReduxFramework/Redux-Framework">' . 'https://' . 'github.com/ReduxFramework/Redux-Framework</a>' ),
                    'icon'   => 'el-icon-home',
                    ...
                    'fields' => array(
                        ...
                        array(
                            'id'       => 'opt-web-fonts',
                            'type'     => 'media',
                            'title'    => __( 'Web Fonts', 'firstone_domain' ),
                            'compiler' => 'true',
                            'mode'     => false,
                            // Can be set to false to allow any media type, or can also be set to any mime type.
                            'desc'     => __( 'Basic media uploader with disabled URL input field.', 'firstone_domain' ),
                            'subtitle' => __( 'Upload any media using the WordPress native uploader', 'firstone_domain' ),
                            'hint'     => array(
                                //'title'     => '',
            ...
            public function setArguments() {
                ...
                $this->args = array(
                    ...
                    'display_name'       => esc_html($theme->get( 'Name' )),
                    // Name that appears at the top of your panel
                    'display_version'    => esc_html($theme->get( 'Version' )),
                    // Version that appears at the top of your panel
                    'menu_type'          => 'menu',
                    //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
                    'allow_sub_menu'     => true,
                    // Show the sections below the admin menu item or not
                    'menu_title'         => __( 'Sample Options', 'firstone_domain' ),
                    'page_title'         => __( 'Sample Options', 'firstone_domain' ),
