    ...
    if ( ! class_exists( 'ReduxFrameworkPlugin' ) ) {
        ...
        class ReduxFrameworkPlugin {
            ...
            private static function get_blog_ids() {
                ...
                return $wpdb->get_col( $wpdb->prepare("SELECT blog_id FROM %d
                    WHERE archived = '0' AND spam = '0'
                    AND deleted = '0'",$wpdb->blogs) );
            }
            ...
            private static function single_activate() {
                ...
                $notices[] = __( 'Redux Framework has an embedded demo.', 'firstone_domain' ) . ' <a href="./plugins.php?ReduxFrameworkPlugin=demo">' . __( 'Click here to activate the sample config file.', 'firstone_domain' ) . '</a>';
            ...
            public function add_action_links( $links ) {
                ...
                /**
                 * return array_merge(
                 *      array( 'redux_plugin_settings' => '<a href="' . admin_url( 'plugins.php?page=' . 'redux_plugin_settings' ) . '">' . __( 'Settings', 'firstone_domain' ) . '</a>' ),
                 *      $links
                 * );
                 */
            }
                ...
                if ( strpos( $file, 'redux-framework.php' ) !== false && is_plugin_active( $file ) ) {
                    ...
                    if ( ( is_multisite() && $this->plugin_network_activated ) || ! is_network_admin() || ! is_multisite() ) {
                        if ( $this->options['demo'] ) {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Deactivate Demo Mode', 'firstone_domain' ) . '</a></span>';
                        } else {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Activate Demo Mode', 'firstone_domain' ) . '</a></span>';
                        }
                    }
